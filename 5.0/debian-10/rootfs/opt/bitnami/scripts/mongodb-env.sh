...
export MONGODB_ROOT_PASSWORD="${MONGODB_ROOT_PASSWORD:-password@123}"
export MONGODB_USERNAME="${MONGODB_USERNAME:-test}"
export MONGODB_PASSWORD="${MONGODB_PASSWORD:-test}"
export MONGODB_DATABASE="${MONGODB_DATABASE:-adcuratio}"
